...
public class SceneBootstrapper
{
    ...
    const string k_LoadBootstrapSceneOnPlay = "Aljava/Load Bootstrap Scene On Play";
    const string k_DoNotLoadBootstrapSceneOnPlay = "Aljava/Don't Load Bootstrap Scene On Play";
